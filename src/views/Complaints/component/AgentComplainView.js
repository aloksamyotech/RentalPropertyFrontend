...
const ComplainDetailsPageForAgent = () => {
          ...
          >
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={6}>
                ...
                <Typography>{agentData.email || t('not_available')}</Typography>
              </Grid>
              <Grid item xs={6}>
                <Typography variant="h5">{t('phone_number')}</Typography>
                <Typography>{agentData.phoneNo || t('not_available')}</Typography>
              </Grid>
            </Grid>
          </Paper>
        </Grid>
...
export default ComplainDetailsPageForAgent;
