...
const TotalComplains = ({ isLoading, complainData }) => {
            ...
            <Grid container direction="column">
              ...
              <Grid item>
                <Grid container alignItems="center" justifyContent="center" position="top">
                  <Grid item>
                    <Typography sx={{ fontSize: '2.125rem', fontWeight: 500, mr: 1, mt: 1.75, mb: 0.75 }}>{complainData?.length}</Typography>
                  </Grid>
                  <Grid item>
                    <Avatar
                      sx={{
